...
# TẦNG 2: CoreDiff (Diffusion Model khôi phục cấu trúc 3D)
# Chức năng: Nhận đầu vào là 3 lát cắt 2D liên tiếp (đã được làm sạch nền bởi Tầng 1 DenoMamba)
# Thực hiện quá trình khuếch tán ngược (Reverse Diffusion) có điều kiện để tái tạo lại
# tính liên tục của giải phẫu theo trục Z, xóa bỏ các nhiễu giả (pseudolesions).
